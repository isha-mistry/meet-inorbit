...
const ChatBar = () => {
  ...
  return (
    <div className="absolute right-0 top-0 h-full flex w-96 rounded-l-lg flex-col bg-gray-100 text-white shadow-lg transition-transform duration-300 ease-in-out">

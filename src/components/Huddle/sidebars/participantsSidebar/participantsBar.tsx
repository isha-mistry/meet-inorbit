...
const ParticipantsBar = () => {
  ...
  return (
    <aside className="absolute right-0 top-0 w-full 0.5xm:w-96 bg-gray-100 h-full mr-2 0.5xm:rounded-l-lg transition-trasform duration-300 ease-in-out shadow-lg">
      <div className="mb-6">
